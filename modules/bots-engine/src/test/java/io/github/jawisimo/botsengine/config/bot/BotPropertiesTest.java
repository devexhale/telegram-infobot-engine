package io.github.jawisimo.botsengine.config.bot;

import static org.junit.jupiter.api.Assertions.*;

import io.github.jawisimo.botsengine.exception.MissingPropertyException;
...
class BotPropertiesTest {
  ...
  private static final String PROPERTY_EXCEPTION_PREFIX_MSG = "Required properties are missing: ";
  ...
  void constructor_shouldThrowMissingPropertyException_whenTokenMissingOrBlank(String token) {
    ...
    String expected = PROPERTY_EXCEPTION_PREFIX_MSG + BOT_TOKEN_PROPERTY;
  ...
  void constructor_shouldThrowMissingPropertyException_whenDialogFileNameMissingOrBlank(
    ...
    int buttonsPerRow = 1;
    boolean userStatePersistent = false;
    String expected = PROPERTY_EXCEPTION_PREFIX_MSG + DIALOG_FILE_NAME_PROPERTY;
  ...
  void constructor_shouldThrowMissingPropertyException_whenTokenAndDialogFileNameInvalid() {
    ...
    String expected =
        PROPERTY_EXCEPTION_PREFIX_MSG
            + String.join(System.lineSeparator(), BOT_TOKEN_PROPERTY, DIALOG_FILE_NAME_PROPERTY);
