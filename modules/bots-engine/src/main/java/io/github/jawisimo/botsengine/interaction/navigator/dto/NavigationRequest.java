 ...
 * components.
 *
 * @param rawInput the original text input received from the user
 * @param nodeKey the resolved dialog node key that should handle the request
 * @param fromButton whether the navigation was triggered by a button interaction
 * @since 1.0
 */
