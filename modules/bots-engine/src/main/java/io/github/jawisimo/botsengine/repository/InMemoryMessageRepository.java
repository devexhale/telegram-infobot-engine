...
public class InMemoryMessageRepository implements MessageRepository {
  ...
  /**
   * Removes all stored message identifiers associated with the given chat and returns them.
   *
   * @param chatId the chat identifier
   * @return a list containing the removed message identifiers, or an empty list if none were stored
   */
  @Override
