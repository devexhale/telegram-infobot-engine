...
class DialogParserProviderTest {
  ...
  void getParser_shouldThrowException_whenNoParserFound() {
    ...
    assertEquals("No suitable parser found for file: " + UNSUPPORTED_FILE, exception.getMessage());
  }
  ...
  void getParser_shouldWorkWithEmptyParserList() {
    ...
    String expected = "No suitable parser found for file: " + CORRECT_YAML_FILE;
