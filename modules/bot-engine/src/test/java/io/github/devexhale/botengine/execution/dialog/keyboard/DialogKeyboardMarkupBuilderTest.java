...
class DialogKeyboardMarkupBuilderTest {

  @Mock private DialogProperties dialogProperties;

  @InjectMocks private DialogKeyboardMarkupBuilder dialogKeyboardMarkupBuilder;
  ...
  void buildReplyKeyboard_shouldSplitButtonsIntoRowsAndSetFlags_whenButtonsProvided(
    ...
    when(dialogProperties.buttonsPerRow()).thenReturn(buttonsPerRow);

    List<Button> buttons = createButtons(buttonsCount);

    ReplyKeyboardMarkup markup = dialogKeyboardMarkupBuilder.buildReplyKeyboard(buttons);
  ...
  void buildInlineKeyboard_shouldSplitButtonsAndMapFields_whenButtonsProvided(
    ...
    InlineKeyboardMarkup markup = dialogKeyboardMarkupBuilder.buildInlineKeyboard(buttons);
  ...
  private static Stream<Arguments> replyKeyboardCases() {
    return Stream.of(
  ...
  private static Stream<Arguments> inlineKeyboardCases() {
    return Stream.of(
        Arguments.of(2, 5, List.of(2, 2, 1)),
