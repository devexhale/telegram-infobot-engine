...
//      boolean persistent) {
//    when(properties.broadcastEnable()).thenReturn(persistent);
//
//    if (persistent) {
...
//    when(properties.broadcastEnable()).thenReturn(true);
//    when(redisRepository.findByChatId(CHAT_ID)).thenReturn(Optional.of(expectedUserState));
//
//    injectRepositories();
//
...
//    when(properties.broadcastEnable()).thenReturn(false);
//    when(inMemoryRepository.findByChatId(CHAT_ID)).thenReturn(Optional.of(expectedUserState));
//
//    injectRepositories();
//
...
//    invokeSetter(
//        IN_MEMORY_USER_STATE_REPOSITORY_SET, InMemoryUserStateRepository.class,
// inMemoryRepository);
//    invokeSetter(REDIS_USER_STATE_REPOSITORY_SET, RedisUserStateRepository.class,
// redisRepository);
//  }
//
