// package io.github.jawisimo.botengine.validator;
//
...
// import io.github.jawisimo.botengine.executor.handler.content.dialog.ContentHandler;
// import java.util.*;
//
// import io.github.jawisimo.botengine.model.*;
...
//    DialogNode next =
//        new DialogNode(null, "End", ButtonType.REPLY, List.of(new Button("Back", START_KEY,
// null)));
//
...
//    DefinitionInitializationException ex =
//        assertThrows(DefinitionInitializationException.class, () -> validator.validate(null,
// DIALOG_FILE));
//
...
//
//    DefinitionInitializationException ex =
//        assertThrows(DefinitionInitializationException.class, () -> validator.validate(map,
// DIALOG_FILE));
//
...
//    DialogNode node =
//        new DialogNode(null, "Msg", ButtonType.UNKNOWN, List.of(new Button("Label", "next",
// null)));
...
// DIALOG_FILE));
//
//    assertTrue(ex.getMessage().contains("Node '/start.content[0].media.type' is missing or
// blank"));
//  }
//
//  @ParameterizedTest
...
//        ex.getMessage()
//            .contains(
//                "Node '/start.content[0].media.file_name' points to missing media file
// 'media/missing-file.jpg'"));
//  }
//
//  @Test
