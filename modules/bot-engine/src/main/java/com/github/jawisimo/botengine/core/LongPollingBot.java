...
/**
 * Entry point of the bot-engine framework representing a Spring-managed Telegram bot.
 *
 ...
 *
 * <p>Execution flow: Telegram API -> TelegramBot -> UpdateConsumer -> UpdateService -> dialog
 * execution pipeline.
 *
 * @since 1.0
 */
